...
function onTouchStart (event) {
  ...
  // Do NOT start if iOS edge swipe is detected. Otherwise iOS add (UIWebView) cannot swipe-to-go-back anymore
...
var defaults = {
  ...
  // To support iOS's swipe-to-go-back gesture (when being used in-add, with UIWebView).
